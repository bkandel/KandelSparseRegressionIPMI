...
<<load.lib, size='small', tidy=F, results='hide'>>=
...
<<sparseRegression, results='hide', size='small', tidy=F>>=
...
<<regressProjections, size='small', tidy=F>>=
...
\caption{Predicting age using our method.  Correlation coefficient in the test dataset using our method is  \Sexpr{age.prediction$stats$corcoeff.test}, with p-value of \Sexpr{age.prediction$stats$pvalue.test}, and using the elastic net is \Sexpr{age.glmnet.corcoeff} with p-value \Sexpr{age.glmnet.pvalue}.}
...
<<vis, tidy=F, size='small', results='hide'>>=
